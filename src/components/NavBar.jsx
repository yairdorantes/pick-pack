...
const NavBar = ({ children }) => {
  ...
  const sideMenuContent = useMemo(
          ...
          >
            <div>
              <svg
                ...
                width="2em"
              >
                <path d="M0 .5A.5.5 0 01.5 0h3a.5.5 0 010 1H1v2.5a.5.5 0 01-1 0v-3zm12 0a.5.5 0 01.5-.5h3a.5.5 0 01.5.5v3a.5.5 0 01-.5.5h-3a.5.5 0 01-.5-.5zM.5 12a.5.5 0 01.5.5V15h2.5a.5.5 0 010 1h-3a.5.5 0 01-.5-.5v-3a.5.5 0 01.5-.5zm15 0a.5.5 0 01.5.5v3a.5.5 0 01-.5.5h-3a.5.5 0 010-1H15v-2.5a.5.5 0 01.5-.5zM4 4h1v1H4V4z" />
    ...
    [showSideMenu, handleLink, orderId, user.rol, logoutClick]
  );
    ...
    <div className="flex select-none flex-col h-screen">
      ...
      <div className="flex flex-1">
        <div
          ...
          className={`fixed w-full h-full backdrop-blur-sm bg-opacity-50  bg-black ${
