...
const Picking = () => {
  ...
  return (
    ...
    >
      <NavBar>
        <Stepper stepGiven={1} />
        <ReturnSheet route={"/picking"} ws={orderId} />
        <InfoBar />
        <ModalChat>
          <button className="btn  bg-blue-200 hover:bg-blue-200 btn-info fixed  bottom-3 right-3">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
              viewBox="0 0 24 24"
              className="rotate-[17deg] fill-[#2953b2]"
              height="30"
              width="30"
